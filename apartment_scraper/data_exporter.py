...
class DataExporter:
    ...
    def export_json(self, filename: str, apartments: list[Apartment]):
        ...
        """
        path = pkg_path.joinpath(
            self.site.value, "clean_data", f"{filename}.json"
        )
        apartment_dict = {
    ...
    def export_csv(self, filename: str, apartments: list[Apartment]):
        ...
        """
        path = pkg_path.joinpath(
            self.site.value, "clean_data", f"{filename}.csv"
        )
